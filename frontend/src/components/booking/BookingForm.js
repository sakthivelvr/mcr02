...
export default function BookingForm() {
  ...
  const submitHandler = (e) => {
    ...
    console.log("Modify price state:  priceDetails", priceDetails, "Total price: ", totalPrice)
    let bookingData = {
  ...
  const vehicleSelectHandler = (vehicle) => {
    ...
    }else if(vehicle[0].category === '40/45_SEATER'){
  ...
  const serviceSelectHandler = (service) => {
    ...
    if(service[0].serviceCategory === "ONE_WAY_TRANSFER" || service[0].serviceCategory === "TWO_WAY_TRANSFER" ||
      service[0].serviceCategory === "CITY_TRANSFER"
    ) {
                  ...
                  {terminalStatus  && ( 
                    ...
                    >
                      ...
                      <Select
                        ...
                        onChange={(t) => {
                          setTerminal(t[0].value); 
                          setDropoffAddress('');
                          setPickupAddress('')
                          if(selectedSubService[0].subServiceCategory === 'AIRPORT_DEP' || selectedSubService[0].subServiceCategory === 'AIRPORT_DEP_ARR'){
                            setDropoffAddress(`Airport ${t[0].value}`)    
                          }else{
                            setPickupAddress(`Airport ${t[0].value}`)
                          }}}
                      />
                    </div>
                  )}
                    ...
                    <TimePicker
                      ...
                      onChange={
                        (t) => {
                          ...
                          if(hrs >= 23 || hrs <6 || (hrs === 6 && mins === 0)) {
                            setMidnightSurcharge(true)
                            document.getElementById("midnightSurcharge").disabled = true;
                        ...
                        // else{r=0; setMidnightSurcharge(false)}
                          ...
                          ...fullPriceDetails, 
                          priceDetails : {...fullPriceDetails.priceDetails, midnightSurcharge : 10}}, fullPriceDetails.paymentMethod));

                          }else{
                            setMidnightSurcharge(false)

                            document.getElementById("midnightSurcharge").disabled = false;
                            dispatch(modifyTotalPriceAction({
                              ...fullPriceDetails, 
                              priceDetails : {...fullPriceDetails.priceDetails, midnightSurcharge : 0}}, fullPriceDetails.paymentMethod));
                ...
                {fullPriceDetails && (<><div className="form-check-outline mb-2 text-start ps-4">
                  ...
                  <div className="form-check-outline mb-2 text-start ps-4">
                    ...
                    <label className="form-check-label" htmlFor="defaultCheck2">
                      Tuas South Boulevard Additional $20
                    </label>
                  </div>
